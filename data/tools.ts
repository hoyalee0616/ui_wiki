...
export const tools: ToolItem[] = [
  ...
  },
  {
    ...
    summary: "AI로 음원에서 보컬과 배경음악을 분리",
    description: "Facebook AI의 Demucs 모델로 음원에서 보컬(목소리)과 반주(배경음악)를 각각 분리해 추출합니다. URL 또는 파일 업로드로 사용 가능.",
    sectionId: "media",
    accent: "purple",
    icon: Music,
    features: ["AI 모델 (htdemucs) 기반 고품질 분리", "보컬·반주 양쪽 추출 가능", "URL 또는 파일 업로드 지원"],
